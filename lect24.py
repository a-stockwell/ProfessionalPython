...
def removeStudent():
    nameToRemove = input('Student to drop from class: ')
...
def main():
    ...
    if action == '1':
        print('Entered choice 1')
        enterGrades()
    elif action == '2':
        print('Entered choice 2')
        removeStudent()
    elif action == '3':
        print('Entered choice 3')
        studentAVGs()
    elif action == '4':
        print('Entered choice 4')
        exit()
    else:
...
if login in admins:
    if admins[login] == passw:
        ...
        print('Invalid password, this program will detonate in 5 seconds!')
else:
